// Source: codedbytahir/motionforge — LiquidText
// Adapted: replaced custom context useCurrentFrame with remotion's
  ...
  return (
    <div className={className} style={{ width, height, position: "relative", ...style }}>
      <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} style={{ overflow: "visible" }}>
        ...
        <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle"
          fontSize={fontSize} fontFamily={fontFamily} fontWeight={fontWeight}
          fill="none" stroke={strokeColor} strokeWidth={strokeWidth} opacity="0.3">
          {text}
        </text>
